...
const plans = [
  ...
  },
  {
    ...
    checkoutPlan: "Basic",
    items: ["200 записів на місяць", "Необмежені послуги", "Публічна сторінка запису", "Email власнику про новий запис"],
  ...
  },
  {
    ...
    featured: true,
    checkoutPlan: "Pro",
    items: ["Необмежені записи", "AI-помічник у Telegram", "Email власнику про новий запис", "Email клієнту з деталями запису", "Нагадування клієнту за 24 години"],
    ...
    <main className="auric-shell">
      ...
      <section className="hero-section">
        <div className="hero-copy" data-reveal>
          ...
          <h1>Запис без зайвої переписки.</h1>
          <p>
